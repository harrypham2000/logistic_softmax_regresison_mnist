...
class SoftmaxClassifier(LogisticClassifier):
    def __init__(self, w_shape,num_classes):
        """__init__
    ...
    def softmax(self, x):
        ...
        # [TODO 2.3]
        # Compute softmax
        zmax=np.max(x,axis=1,keepdims=True).reshape(-1,1)
        exp_x=np.exp(x-zmax)
...
if __name__ == "__main__":
    ...
    num_classes=10
    dec_classifier = SoftmaxClassifier(num_features, num_classes)
